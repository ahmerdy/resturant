		...
		<div class="row" style="padding-left: 50px; padding-right: 50px;">
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4">Kano state<i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
			        </div>
				    </div>
				    <div class="card-reveal">
				      <span class="card-title grey-text text-darken-4">Kano state<i class="material-icons right">close</i></span>
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4">Sokoto<i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
			        </div>
				    </div>
				    <div class="card-reveal">
				      <span class="card-title grey-text text-darken-4">Sokoto<i class="material-icons right">close</i></span>
				      <p>Sokoto cuisine is an important part of Sokoto culture, which includes cuisine originating from the diverse regions of China.</p>
				    </div>
				  </div>
			</div>
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
